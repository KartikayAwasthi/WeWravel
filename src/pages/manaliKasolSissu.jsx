  ...
  return (
    <div className="bg-gray-50 min-h-screen p-8">
      <div className="max-w-6xl mx-auto bg-white shadow-2xl rounded-2xl overflow-hidden">
        <img
          src="https://experiencemyindia.com/wp-content/uploads/2024/09/Manali-1-1200x628.jpg"
          alt="Manali - Kasol - Sissu"
          className="w-full h-96 object-cover"
        />
        <div className="p-8 space-y-8">
          <h1 className="text-4xl font-extrabold text-gray-800 text-center">Manali - Kasol - Sissu</h1>
          <p className="text-gray-600 text-lg text-center leading-relaxed">
            Experience the magic of Himachal Pradesh with this breathtaking tour that takes you through the scenic landscapes of Manali, the serene vibes of Kasol, and the majestic beauty of Sissu.
          </p>
...
<div className="text-center mt-8">
  <a
    href="https://api.whatsapp.com/send?phone=+918181862121&text=Hello!%20I'm%20interested%20in%20booking%20the%20Manali-Kasol-Sissu%20trip."
    target="_blank"
    rel="noopener noreferrer"
  >
    <button className="bg-green-500 text-white px-6 py-3 rounded-lg text-lg font-semibold shadow-lg hover:bg-green-600 transition">
      Book Now
    </button>
  </a>
</div>
